...
boton_fruta = tk.Button(frame1, text="Frutas", bg="#4FC3F7", command=lambda: comenzar_juego("Frutas"))
boton_fruta.pack(pady=5)

boton_termino = tk.Button(frame1, text="Conceptos Informáticos", bg="#4FC3F7", command=lambda: comenzar_juego("Conceptos Informáticos"))
boton_termino.pack(pady=5)

boton_nombres = tk.Button(frame1, text="Nombres", bg="#4FC3F7", command=lambda: comenzar_juego("Nombres"))
boton_nombres.pack(pady=5)

boton_salir = tk.Button(frame1, text="Salir", bg="#4FC3F7", command=ventana.quit)
...
boton_verificar = tk.Button(frame2, text="Verificar Letra", bg="#4FC3F7", command=verificar_letra)
boton_verificar.pack(pady=10)

label_intentos = tk.Label(frame2, text="Intentos: 0/6", bg="#4E7C7E", fg="white", font=("Arial", 12))
label_intentos.pack(pady=10)

boton_volver = tk.Button(frame2, text="Volver", bg="#4FC3F7", command=reiniciar_juego)
